...
```
cd existing_repo
git remote add origin https://gitlab.tech.orange/xu.sun/mini_qwen.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.tech.orange/xu.sun/mini_qwen/-/settings/integrations)
